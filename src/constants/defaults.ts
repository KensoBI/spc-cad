      ...
      components: [
        {
          ...
          title: 'x 1',
          type: 'timeseries',
          settings: { timeseries: defaults({ characteristicName: 'x' }, defaultTimeseriesSettings) },
        },
      ],
    },
    {
      ...
      components: [
        {
          ...
          title: 'y 1',
          type: 'timeseries',
          settings: { timeseries: defaults({ characteristicName: 'y' }, defaultTimeseriesSettings) },
        },
      ],
    },
    {
      ...
      components: [
        {
          ...
          title: 'z 1',
          type: 'timeseries',
          settings: { timeseries: defaults({ characteristicName: 'z' }, defaultTimeseriesSettings) },
        },
      ],
    },
  ],
