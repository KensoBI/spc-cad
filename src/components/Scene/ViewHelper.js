...
class ViewHelper extends Object3D {
	...
	constructor( camera, domElement ) {
		...
		const spriteMaterial4 = getSpriteMaterial( color1 );
		const spriteMaterial5 = getSpriteMaterial( color2 );
		const spriteMaterial6 = getSpriteMaterial( color3 );
		...
		const negYAxisHelper = new Sprite( spriteMaterial5 );
		const negZAxisHelper = new Sprite( spriteMaterial6 );
